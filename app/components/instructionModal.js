    ...
    return (
        ...
        >
            <div 
                ...
                <p className="text-lg font-libre-baskerville font-bold text-center content-color">Update Step Instruction</p>
                    <label htmlFor="step" className="content-color font-roboto text-base">Step:</label>
                    <input
                    ...
                    <label htmlFor="description" className="content-color font-roboto text-base">Description:</label>
                    <textarea 
                        className="w-11/12 p-2 block mt-4 mb-2 content-color font-roboto text-base rounded-lg secondary-background-color border border-color focus:border-2 focus:outline-none"
                        name="description"
                        rows="6"
