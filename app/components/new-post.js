...
export default function NewPost({onCreatePost, onCloseForm, onSetImage}) {
  ...
  return (
    <div className="absolute inset-0 w-full bg-gray-300/50 flex justify-center items-center h-fit"
            onClick={onCloseForm}>
        <div className="w-3/4 mt-6 border-2 border-color rounded-3xl mb-8 mx-8 main-background-color"
