      ...
      <div className="border-2 border-color rounded-3xl w-11/12 my-10">
          <div className="flex flex-col items-center justify-center h-content px-8 mb-5">
            ...
            <p className="text-lg font-libre-baskerville mb-4">
              {data.category.toUpperCase()} FOOD · {data.timeTaken.toUpperCase()} · {data.portion} SERVINGS
            </p>
            <div className="flex justify-center items-center">
              <img src="/images/not-found.jpg" alt="dish" className="w-60 h-60 rounded-lg mb-4" />
            </div>
          ...
          <div className="grid grid-cols-4 px-8">
                ...
                {Array.isArray(data.instructions) && data.instructions.length > 0 ? (
                  <ul className="ml-4">
                    {data.instructions.map((instruction, index) => (
                      <div className="mb-6">
                        <li key={index}><Heading3 title={instruction.step} /></li>
            ...
            <div className="col-span-1">
              <div className="border-2 border-color rounded-3xl p-8 secondary-background-color ">
                <h3 className="text-lg font-bold font-roboto mb-2 title-color">INGREDIENTS</h3>
